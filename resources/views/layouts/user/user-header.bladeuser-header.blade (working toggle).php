    ...
    <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto py-6 px-12">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" class="sr-only peer" id="role-toggle"
                    {{ $role === 'publisher' ? 'checked' : '' }}>
                <div
                    class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                </div>
                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300" id="role-label">
            ...
            <!-- Role-Specific Link -->
            @if ($role === 'vendor')
                <a href="#" class="ml-3 text-sm font-medium text-blue-600 dark:text-blue-500">Vendor</a>
            @else
                <a href="#" class="ml-3 text-sm font-medium text-blue-600 dark:text-blue-500">Publisher</a>
            @endif
